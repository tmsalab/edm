...
[![Travis-CI Build Status](https://travis-ci.org/tmsalab/ecdm.svg?branch=master)](https://travis-ci.org/tmsalab/ecdm)
[![CRAN\_Status\_Badge](http://www.r-pkg.org/badges/version/ecdm)](https://cran.r-project.org/package=ecdm)
[![CRAN RStudio mirror downloads](http://cranlogs.r-pkg.org/badges/ecdm)](http://www.r-pkg.org/pkg/ecdm)
[![Coverage Status](https://img.shields.io/codecov/c/github/tmsalab/ecdm/master.svg)](https://codecov.io/github/tmsalab/ecdm?branch=master)
...
These classical CDMs are implemented in separate packages: `dina` and `rrum`.
