...
//' @noRd
arma::vec abcounts(unsigned int N, const arma::vec &Yj, const arma::vec &CLASS,
...
//' @noRd
double llj(unsigned int N, const arma::vec &Yj, const arma::vec &ETAj,
...
//'               least one attribute is lacking.
//' @noRd
double pYit(const arma::vec &ETA_it, const arma::vec &Y_it, const arma::vec &ss,
            const arma::vec &gs)
{
